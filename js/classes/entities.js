...
class RailGun extends ShipWeapon{
    ...
    fire(){
        ...
        this.owner.sector.layer3.add(new Slug(this.owner.name + " slug", this.owner.x, this.owner.y, this.owner.color, "drawSlug", this.owner, this.owner.target, direc, 100, 1000, 50));
    }
    update(){
        if(!!this.owner.target){
            if(this.reloading){
